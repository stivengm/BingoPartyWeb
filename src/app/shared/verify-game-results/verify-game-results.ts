...
export class VerifyGameResults implements OnInit {
  ...
  allBalls = [
    ...
    { id: 37, isComplete: false },
    { id: 38, isComplete: false },
    { id: 39, isComplete: true },
    { id: 40, isComplete: false },
    ...
    { id: 46, isComplete: false },
    { id: 47, isComplete: false },
    ...
    { id: 58, isComplete: false },
    { id: 59, isComplete: false },
    ...
    { id: 65, isComplete: false },
    { id: 66, isComplete: true },
    { id: 67, isComplete: false },
    { id: 68, isComplete: false },
